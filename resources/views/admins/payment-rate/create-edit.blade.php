...
<script>
    $(document).ready(function() {
        ...
        // Function to fetch classrooms dynamically based on school, gender, and jamaah status
        ...
        // Auto Pemisah Ribuan (Thousands Separator) pada UI Nominal
        ...
        $(document).on('input keyup', '.input-money, #setPrice, [name^="bulan_"]', function() {
            var raw = $(this).val();
            var formatted = formatThousandString(raw);
            $(this).val(formatted);
        });

        // Format saat halaman diload (mode edit atau initial)
        ...
        // Bersihkan titik sebelum form disubmit
        $('#payment-rate-form').on('submit', function() {
            $('.input-money, #setPrice, [name^="bulan_"]').each(function() {
