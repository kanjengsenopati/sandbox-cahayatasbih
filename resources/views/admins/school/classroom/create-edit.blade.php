    ...
    <div class="toolbar" id="kt_toolbar">
        ...
        <div id="kt_toolbar_container" class="container-fluid d-flex flex-stack">
            ...
            <div data-kt-swapper="true" data-kt-swapper-mode="prepend"
                ...
                <!--begin::Title-->
                <h1 class="d-flex text-dark fw-bolder fs-3 align-items-center my-1">Data Kelas</h1>
                <!--end::Title-->
                <!--begin::Separator-->
                ...
                <ul class="breadcrumb breadcrumb-separatorless fw-bold fs-7 my-1">
                    ...
                    <li class="breadcrumb-item text-dark">
                        {{ request()->routeIs('classroom.create') ? 'Tambah Kelas' : 'Edit Kelas' }}</li>
                    <!--end::Item-->
                </ul>
                <!--end::Breadcrumb-->
            </div>
                ...
                <div class="col-xl-12">
                    ...
                    <div class="card card-flush h-lg-100" id="kt_contacts_main">
                        ...
                        <div class="card-header pt-7" id="kt_chat_contacts_header">
                            ...
                            <div class="card-title">
                                <h1 class="d-flex text-dark fw-bolder fs-3 align-items-center">{{
                                    request()->routeIs('classroom.create') ? 'Tambah Kelas' : 'Edit Kelas' }}
                                </h1>
                            </div>
                            <!--end::Card title-->
                        </div>
                        ...
                        <div class="card-body pt-5">
                            ...
                            <form id="classroom"
                                action="{{ request()->routeIs('classroom.create') ? route('classroom.store') : route('classroom.update', @$classroom->id) }}"
                                ...
                                <div class="fv-row mb-7">
                                    ...
                                    <label class="fs-6 fw-bold form-label mt-3" for="name">
                                        ...
                                        <i class="fas fa-exclamation-circle ms-1 fs-7" data-bs-toggle="tooltip"
                                            title="Masukkan Nama Kelas"></i>
                                    </label>
                                    <!--end::Label-->
                                    <!--begin::Input-->
                                    <input type="text" class="form-control form-control-solid" name="name" id="name"
                                        placeholder="Masukkan Nama Kelas" value="{{ @$classroom->name ?? old('name') }}"
                                        required />
                                    <!--end::Input-->
                                </div>
                                <input type="hidden" name="school_id"
                                    value="{{ request()->routeIs('classroom.create') ? request()->get('school') : @$classroom->school_id }}">
                                <!--end::Input group-->
                                <!--begin::Separator-->
