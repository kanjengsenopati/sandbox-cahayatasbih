@extends('layouts.master', ['title' => 'Laporan Raport Nilai Akademik'])
@section('content')
            ...
            <div data-kt-swapper="true" data-kt-swapper-mode="prepend"
                ...
                <ul class="breadcrumb breadcrumb-separatorless fw-bold fs-7 my-1">
                    ...
                    <li class="breadcrumb-item text-muted">
                        <a href="{{ route('report-study-grade.index') }}" class="text-muted text-hover-primary">Laporan
                            Raport Nilai</a>
                    </li>
                    <!--end::Item-->
                    <!--begin::Item-->
                    ...
                    <!--end::Item-->
                    <!--begin::Item-->
                    <li class="breadcrumb-item text-dark">Data Nilai Akademik</li>
                    <!--end::Item-->
                </ul>
                <!--end::Breadcrumb-->
            </div>
            ...
            <div class="card mb-5">
                ...
                <div
                    ...
                    <div class="d-flex flex-wrap justify-content-beetween gap-5">
                        ...
                        <div class="mb-0">
                            <form action="{{ route('report-study-grade.export') }}" id="form-filter" method="get">
...
<script>
    ...
    serverSide: true,
    ajax: {
    url: "{{ route('report-study-grade.index') }}",
    data: function(d) {
