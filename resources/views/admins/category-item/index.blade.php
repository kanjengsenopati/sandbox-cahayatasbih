            ...
            <div data-kt-swapper="true" data-kt-swapper-mode="prepend"
                ...
                <ul class="breadcrumb breadcrumb-separatorless fw-bold fs-7 my-1">
                    ...
                    <li class="breadcrumb-item text-muted">
                        <a href="{{ route('category-item.index') }}" class="text-muted text-hover-primary">Kategori
                            Barang</a>
                    </li>
                    <!--end::Item-->
                    <!--begin::Item-->
                    ...
                    <!--end::Item-->
                    <!--begin::Item-->
                    <li class="breadcrumb-item text-dark">List Kategori Barang</li>
                    <!--end::Item-->
                </ul>
                <!--end::Breadcrumb-->
            </div>
            ...
            <div class="card">
                ...
                <div class="card-header d-flex align-items-center justify-content-between border-0 pt-6">
                    ...
                    <div class="">
                        <a type="a" class="btn btn-sm btn-primary" id="btn_add_permission"
                            href="{{ route('category-item.create') }}">+ Kategori</a>
                        <!--end::Primary button-->
                    </div>
                    <!--end::Card title-->
                </div>
                ...
                <div class="card-body pt-0">
                    ...
                    <div class="table-responsive">
                        <table id="table-category-item" class="table align-middle table-row-dashed ">
                            <thead>
...
<script>
    $(document).ready(() => {
            var table = $('#table-category-item').DataTable({
                ordering: false,
                processing: true,
                serverSide: true,
