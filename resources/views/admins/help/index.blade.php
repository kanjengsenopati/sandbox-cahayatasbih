@extends('layouts.master', ['title' => 'Data Contact Center'])
@section('content')
            ...
            <div class="card">
                ...
                <div class="card-body pt-0">
                    ...
                    <div class="table-responsive">
                        <table id="table-help" class="table align-middle table-row-dashed ">
                            <thead>
                                <tr class="text-start text-gray-400 fw-bolder fs-7 text-uppercase gs-0">
                                    <th style="width: 5%">No</th>
                                    <th style="width: 22%">Foto</th>
...
<script>
    $(document).ready(() => {
            var table = $('#table-help').DataTable({
                ordering: false,
                processing: true,
                serverSide: true,
