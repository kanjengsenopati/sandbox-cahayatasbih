@extends('layouts.master', ['title' => 'Data Bank TopUp Tabungan'])
@section('content')
<!--begin::Content-->
                ...
                <div class="col-xl-12">
                    ...
                    <div class="card card-flush h-lg-100" id="kt_contacts_main">
                        ...
                        <div class="card-body pt-5">
                            ...
                            <form id="saldo-bank" action="{{ route('saving-bank.update', @$school->id) }}" method="POST"
                                ...
                                <div class="d-flex justify-content-end">
                                    <!--begin::Button-->
                                    <a href="{{ route('saving-bank.index') }}">
