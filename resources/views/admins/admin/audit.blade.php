...
@section('content')
        ...
        <div class="post d-flex flex-column-fluid" id="kt_post">
            ...
            <div id="kt_content_container" class="container-xxl">
                ...
                <div class="card card-flush shadow-sm mb-6">
                    <div class="card-body py-0 px-0">
                        <ul class="nav nav-stretch nav-line-tabs nav-line-tabs-2x border-transparent fs-5 fw-bolder px-6" id="audit-tabs" role="tablist">
                            ...
                            <li class="nav-item" role="presentation">
                                <a class="nav-link text-active-primary py-5 me-6"
                                   id="tab-duplicate-students-trigger"
                                   data-bs-toggle="tab"
                                   href="#tab-duplicate-students"
                                   role="tab"
                                   aria-controls="tab-duplicate-students"
                                   aria-selected="false">
                                    <i class="fas fa-users me-2 fs-6"></i>
                                    Siswa Duplikat
                                </a>
                            </li>
                        </ul>
                ...
                <div class="tab-content" id="audit-tabs-content">
                    ...
                    {{-- ===== TAB 3: SISWA DUPLIKAT ===== --}}
                    <div class="tab-pane fade" id="tab-duplicate-students" role="tabpanel" aria-labelledby="tab-duplicate-students-trigger">
    ...
    <script>
        document.addEventListener('DOMContentLoaded', function () {
            ...
            var tabDuplicate   = document.getElementById('tab-duplicate-students-trigger');
            ...
            function hideAllToolbarBtns() { btnSync.style.display = 'none'; btnAudit.style.display = 'none'; }
            ...
            if (tabDuplicate) {
                tabDuplicate.addEventListener('shown.bs.tab', hideAllToolbarBtns);
            }

            // Jika redirect ke tab tertentu via query url (?tab=duplicate-students)
            const urlParams = new URLSearchParams(window.location.search);
            const activeTab = urlParams.get('tab');
            if (activeTab === 'duplicate-students' && tabDuplicate) {
                tabDuplicate.click();
            } else {
