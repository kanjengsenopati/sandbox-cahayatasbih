            ...
            <div class="card">
                ...
                <div class="card-body pt-0">
                    ...
                    <div class="table-responsive">
                        <table id="table-student-counseling-score" class="table table-striped border rounded gy-5 gs-7">
                            <thead>
...
<script>
    $(document).ready(() => {
        var table = $('#table-student-counseling-score').DataTable({
            ordering: false,
            processing: true,
            serverSide: true,
            ajax: "{{ route('student-counseling-score.index') }}",
            language: {
                paginate: {
