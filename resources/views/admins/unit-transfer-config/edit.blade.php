                ...
                <div class="card-body py-4">
                    <form action="{{ route('unit-transfer-config.update', $unitTransferConfig->id) }}" method="POST">
                        ...
                        <div class="row mb-6">
                            ...
                            <div class="col-lg-8">
                                <input type="number" name="amount" class="form-control form-control-solid" placeholder="Contoh: 500000" value="{{ old('amount', $unitTransferConfig->amount) }}" min="0" required />
