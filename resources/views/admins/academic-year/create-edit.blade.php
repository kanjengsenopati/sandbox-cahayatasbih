    ...
    <div class="toolbar" id="kt_toolbar">
        ...
        <div id="kt_toolbar_container" class="container-fluid d-flex flex-stack">
            ...
            <div data-kt-swapper="true" data-kt-swapper-mode="prepend"
                ...
                <!--begin::Title-->
                <h1 class="d-flex text-dark fw-bolder fs-3 align-items-center my-1">Data Tahun Ajaran</h1>
                <!--end::Title-->
                <!--begin::Separator-->
                ...
                <ul class="breadcrumb breadcrumb-separatorless fw-bold fs-7 my-1">
                    ...
                    <!--end::Item-->
                    <!--begin::Item-->
                    <a class="breadcrumb-item" href="{{ route('academic-year.index') }}">
                        <li class="text-muted">
                            Tahun Ajaran
                        </li>
                    </a>
                    ...
                    <li class="breadcrumb-item text-dark">
                        {{ request()->routeIs('academic-year.create') ? 'Tambah Tahun Ajaran' : 'Edit Tahun Ajaran' }}
                    </li>
                    <!--end::Item-->
                </ul>
                <!--end::Breadcrumb-->
                ...
                <div class="col-xl-12">
                    ...
                    <div class="card card-flush h-lg-100" id="kt_contacts_main">
                        ...
                        {{-- <div class="card-header pt-7" id="kt_chat_contacts_header">
                            ...
                            <div class="card-title">
                                <h1 class="d-flex text-dark fw-bolder fs-3 align-items-center">{{
                                    request()->routeIs('academic-year.create') ? 'Tambah Sekolah' : 'Edit Sekolah' }}
                                </h1>
                            </div>
                            <!--end::Card title-->
                        </div> --}}
                        ...
                        <div class="card-body pt-5">
                            ...
                            <form id="academic-year"
                                action="{{ request()->routeIs('academic-year.create') ? route('academic-year.store') : route('academic-year.update', @$academicYear->id) }}"
