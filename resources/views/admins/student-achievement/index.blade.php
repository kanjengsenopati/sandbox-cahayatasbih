@extends('layouts.master', ['title' => 'Data Prestasi Siswa'])
@section('content')
    ...
    <div class="toolbar" id="kt_toolbar">
        ...
        <div id="kt_toolbar_container" class="container-fluid d-flex flex-stack">
            ...
            <div data-kt-swapper="true" data-kt-swapper-mode="prepend"
                ...
                <!--begin::Title-->
                <h1 class="d-flex text-dark fw-bolder fs-3 align-items-center my-1"> Daftar Prestasi Siswa</h1>
                <!--end::Title-->
                <!--begin::Separator-->
                ...
                <ul class="breadcrumb breadcrumb-separatorless fw-bold fs-7 my-1">
                    ...
                    <li class="breadcrumb-item text-muted">
                        <a href="{{ route('student-achievement.index') }}"
                            class="text-muted text-hover-primary">Prestasi</a>
                    </li>
                    <!--end::Item-->
                    <!--begin::Item-->
                    ...
                    <!--end::Item-->
                    <!--begin::Item-->
                    <li class="breadcrumb-item text-dark">List Prestasi</li>
                    <!--end::Item-->
            ...
            <div class="card">
                ...
                <div class="card-body pt-0">
                    ...
                    <div class="table-responsive">
                        <table id="table-student-achievement" class="table table-striped border rounded gy-5 gs-7">
                            <thead>
...
<script>
    $(document).ready(() => {
    var table = $('#table-student-achievement').DataTable({
    ordering: false,
    processing: true,
    serverSide: true,
