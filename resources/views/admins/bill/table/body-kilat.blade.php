                ...
                <div class="row w-100 align-items-center pe-3">
                    ...
                    <div class="col-md-6 d-flex flex-column text-start">
                         <div class="d-flex align-items-center mb-1">
                             ...
                             <span class="badge badge-light-primary fw-bold fs-8">Bulanan</span>
                         </div>
                            ...
                            <div class="mt-2 d-flex justify-content-center align-items-center">
                                ...
                                @elseif($showModal)
                                    <div class="form-check form-check-custom form-check-solid form-check-sm">
                                        ...
                                        <label class="form-check-label fw-bold text-gray-700 ms-2 fs-7 cursor-pointer" for="bill-month-{{ $bill->id }}-{{ $month }}" onclick="event.stopPropagation()">
                                            Bayar
                                        </label>
                                    </div>
                                @else
