                ...
                <div class="row w-100 align-items-center pe-3">
                    ...
                    <div class="col-md-3 col-12 my-2 my-md-0 d-flex align-items-center justify-content-start justify-content-md-center">
                        ...
                        <div class="d-flex align-items-center gap-2.5 px-3 py-1.5 rounded-3" 
                            ...
                            <div class="symbol symbol-25px symbol-circle {{ $rombelData['is_pondok'] ? 'bg-light-success' : 'bg-light-primary' }} me-1">
                                <span class="symbol-label {{ $rombelData['is_pondok'] ? 'text-success' : 'text-primary' }} fw-bolder fs-8">
                                    <i class="{{ $rombelData['is_pondok'] ? 'fas fa-mosque text-success' : 'fas fa-door-open text-primary' }} fs-8"></i>
                                </span>
                            </div>
