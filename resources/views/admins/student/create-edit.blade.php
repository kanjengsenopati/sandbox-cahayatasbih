                ...
                <div class="card-body pt-9 pb-0">
                                ...
                                <div class="d-flex flex-column flex-grow-1 pe-8">
                                    ...
                                    <div class="d-flex flex-wrap">
                                        ...
                                        <div
                                            ...
                                            <!--end::Number-->
                                            <!--begin::Label-->
                                            <div class="fw-bold fs-6 text-gray-400">Saldo Masuk</div>
                                            <!--end::Label-->
                                        </div>
                                        <!--end::Stat-->
                                        <!--begin::Stat-->
                                        <div
                                            ...
                                            <!--end::Number-->
                                            <!--begin::Label-->
                                            <div class="fw-bold fs-6 text-gray-400">Saldo Keluar</div>
                                            <!--end::Label-->
                                        </div>
                                        <!--end::Stat-->
                                        <!--begin::Stat-->
                                ...
                                {{-- <div class="d-flex align-items-center w-200px w-sm-300px flex-column mt-3">
                                    <div class="d-flex justify-content-between w-100 mt-auto mb-2">
                                        <span class="fw-bold fs-6 text-gray-400">
                                            Informasi Diatas Merupakan Ringkasan Saldo Bulan Ini
                                        </span>
                                    </div>
                                </div> --}}
                                <!--end::Progress-->
                    ...
                    <ul class="nav nav-stretch nav-line-tabs nav-line-tabs-2x border-transparent fs-5 fw-bolder">
                        ...
                        <li class="nav-item mt-2">
                            <a class="nav-link text-active-primary ms-0 me-10 py-5 active" href="">Data Siswa</a>
                        </li>
                        <!--end::Nav item-->
                        <!--begin::Nav item-->
                        <li class="nav-item mt-2">
                            <a class="nav-link text-active-primary ms-0 me-10 py-5" href="">Data Keuangan</a>
                        </li>
                        <!--end::Nav item-->
                        <!--begin::Nav item-->
                        <li class="nav-item mt-2">
                            <a class="nav-link text-active-primary ms-0 me-10 py-5" href="">Data Prestasi</a>
                        </li>
                        <!--end::Nav item-->
                        <!--begin::Nav item-->
                        {{-- <li class="nav-item mt-2">
