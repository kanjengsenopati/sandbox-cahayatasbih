            ...
            <div data-kt-swapper="true" data-kt-swapper-mode="prepend"
                ...
                <ul class="breadcrumb breadcrumb-separatorless fw-bold fs-7 my-1">
                    ...
                    <li class="breadcrumb-item text-muted">
                        <a href="{{ route('outlet.index') }}" class="text-muted text-hover-primary">Master Data</a>
                    </li>
                    <!--end::Item-->
                    <!--begin::Item-->
                    ...
                    <!--end::Item-->
                    <!--begin::Item-->
                    <li class="breadcrumb-item text-dark">Data Outlet</li>
                    <!--end::Item-->
                </ul>
                <!--end::Breadcrumb-->
            </div>
        ...
        <div id="kt_content_container" class="container-xxl">
            ...
            <div class="card">
                ...
                <div class="card-header d-flex align-items-center justify-content-between border-0 pt-6">
                    ...
                    <x-action.create name="Outlet" action="{{ route('outlet.create') }}" />
                    <!--end::Card title-->
                </div>
                <!--end::Card header-->
                <!--begin::Card body-->
