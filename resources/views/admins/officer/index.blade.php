            ...
            <div data-kt-swapper="true" data-kt-swapper-mode="prepend"
                ...
                <ul class="breadcrumb breadcrumb-separatorless fw-bold fs-7 my-1">
                    ...
                    <li class="breadcrumb-item text-muted">
                        <a href="{{ route('officer.index') }}" class="text-muted text-hover-primary">Petugas</a>
                    </li>
                    <!--end::Item-->
                    <!--begin::Item-->
        ...
        <div id="kt_content_container" class="container-xxl">
            ...
            <div class="card">
                ...
                <div class="card-header d-flex align-items-center justify-content-between border-0 pt-6">
                    ...
                    <x-action.create name="Petugas" action="{{ route('officer.create') }}" />
                </div>
                <!--end::Card header-->
                <!--begin::Card body-->
                <div class="card-body pt-0">
                    ...
                    <div class="table-responsive">
                        <table id="table-officer" class="table align-middle table-row-dashed">
                            <thead>
...
<script>
    $(document).ready(() => {
        var table = $('#table-officer').DataTable({
            ordering: false,
            processing: true,
            serverSide: true,
