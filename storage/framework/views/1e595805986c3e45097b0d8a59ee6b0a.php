                    ...
                    <div class="card card-xl-stretch mb-xl-8 shadow-sm rounded-4 border-0 card-metric">
                        <div class="card-body d-flex align-items-center">
                            ...
                            <div class="d-flex flex-column">
                                <span class="fw-bolder fs-2x text-dark"><?php echo e(number_format($totalSantri)); ?></span>
                ...
                <div class="col-xl-3 col-md-6">
                    <div class="card card-xl-stretch mb-xl-8 shadow-sm rounded-4 border-0 card-metric">
                        <div class="card-body d-flex align-items-center">
                            ...
                            <div class="d-flex flex-column">
                                <span class="fw-bolder fs-2x text-dark"><?php echo e(number_format($totalStaff)); ?></span>
                ...
                <div class="col-xl-3 col-md-6">
                    <div class="card card-xl-stretch mb-xl-8 shadow-sm rounded-4 border-0 card-metric">
                        <div class="card-body d-flex align-items-center">
                            ...
                            <div class="d-flex flex-column">
                                <span class="fw-bolder fs-2x text-dark"><?php echo e(number_format($totalWali)); ?></span>
                ...
                <div class="col-xl-3 col-md-6">
                    <div class="card card-xl-stretch mb-xl-8 shadow-sm rounded-4 border-0 card-metric">
                        <div class="card-body d-flex align-items-center">
                            ...
                            <div class="d-flex flex-column">
                                <span class="fw-bolder fs-2x text-dark"><?php echo e(number_format($totalKelas)); ?></span>
                                                ...
                                                <div class="d-flex align-items-center">
                                                    <div class="symbol symbol-45px me-5">
                                                        <span class="symbol-label bg-light-purple text-purple fw-bold">
                                                            <?php echo e(substr($school->name, 0, 1)); ?>

                                                        </span>
                                                    </div>
                                                    <div class="d-flex justify-content-start flex-column">
                                                        <span class="text-dark fw-bolder text-hover-primary fs-6"><?php echo e($school->name); ?></span>
                                                        <span class="text-muted fw-bold text-muted d-block fs-7"><?php echo e($school->type); ?></span>
                                                    </div>
                                                </div>
                                            </td>
                                            <td>
                                                <span class="badge badge-light-primary fs-7 fw-bold"><?php echo e($school->count_l); ?></span>
                                            </td>
                                            <td>
                                                <span class="badge badge-light-danger fs-7 fw-bold"><?php echo e($school->count_p); ?></span>
                                            </td>
                                            <td>
                                                <span class="text-dark fw-bolder fs-6"><?php echo e($school->total_students); ?></span>
                                            </td>
                                            <td>
                                                <span class="text-dark fw-bolder fs-6"><?php echo e($school->total_classes); ?></span>
                                            </td>
                                        </tr>
                            ...
                            <div class="d-flex flex-stack mt-4">
                                <div class="d-flex align-items-center me-3">
                                    ...
                                    <div class="d-flex flex-column text-start">
                                        ...
                                        <span class="fw-bolder text-gray-800 fs-5"><?php echo e($genderRatio['l']); ?></span>
                                    </div>
                                </div>
                                <div class="d-flex align-items-center me-3">
                                    ...
                                    <div class="d-flex flex-column text-start">
                                        ...
                                        <span class="fw-bolder text-gray-800 fs-5"><?php echo e($genderRatio['p']); ?></span>
                                    </div>
                                </div>
                            </div>
                        </div>
            ...
            <div class="row g-5 g-xl-8">
                        ...
                        <div class="card-body">
                            ...
                            <div class="d-flex flex-column mb-7">
                                <div class="d-flex justify-content-between w-100 fs-4 fw-bolder mb-3">
                                    ...
                                    <span><?php echo e($loginActivity['staff_count']); ?> / <?php echo e($loginActivity['staff_total']); ?></span>
                                </div>
                                <div class="h-8px mx-3 w-100 bg-light-purple rounded">
                                    <div class="bg-purple rounded h-8px" role="progressbar" style="width: <?php echo e($loginActivity['staff_percentage']); ?>%;" aria-valuenow="<?php echo e($loginActivity['staff_percentage']); ?>" aria-valuemin="0" aria-valuemax="100"></div>
                                </div>
                                <div class="fw-bold text-gray-400 mt-2 ms-3"><?php echo e($loginActivity['staff_percentage']); ?>% Staff telah login hari ini</div>
                            </div>
                            ...
                            <div class="d-flex flex-column">
                                <div class="d-flex justify-content-between w-100 fs-4 fw-bolder mb-3">
                                    ...
                                    <span><?php echo e($loginActivity['wali_count']); ?> / <?php echo e($loginActivity['wali_total']); ?></span>
                                </div>
                                <div class="h-8px mx-3 w-100 bg-light-success rounded">
                                    <div class="bg-success rounded h-8px" role="progressbar" style="width: <?php echo e($loginActivity['wali_percentage']); ?>%;" aria-valuenow="<?php echo e($loginActivity['wali_percentage']); ?>" aria-valuemin="0" aria-valuemax="100"></div>
                                </div>
                                <div class="fw-bold text-gray-400 mt-2 ms-3"><?php echo e($loginActivity['wali_percentage']); ?>% Wali Santri telah akses aplikasi</div>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="col-lg-6">
                    <div class="card card-xl-stretch mb-5 mb-xl-8 shadow-sm rounded-4 border-0">
                        ...
                        <div class="card-body pt-5">
                            <?php if(isset($upcomingSchedules) && $upcomingSchedules->count() > 0): ?>
                                    ...
                                    <?php $__currentLoopData = $upcomingSchedules; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $schedule): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <div class="d-flex align-items-center mb-6">
                                            ...
                                            <div class="d-flex flex-column align-items-center justify-content-center bg-light-purple rounded min-w-60px h-60px me-5">
                                                <span class="fs-2 fw-bolder text-purple lh-1"><?php echo e($schedule->date->format('d')); ?></span>
                                                <span class="fs-7 fw-bold text-gray-500 lh-1 mt-1"><?php echo e(\Illuminate\Support\Str::upper($schedule->date->translatedFormat('M'))); ?></span>
                                            </div>
                                            
                                            <!-- Content -->
                                            <div class="d-flex flex-column flex-grow-1">
                                                <span class="text-dark fw-bolder fs-6 mb-1"><?php echo e($schedule->name); ?></span>
                                                <span class="text-gray-400 fw-bold fs-7 description-truncate mb-1"><?php echo e(\Illuminate\Support\Str::limit($schedule->description, 50)); ?></span>
                                                <div>
                                                    <?php if($schedule->type == 'SCHOOL' && $schedule->school): ?>
                                                        <span class="badge badge-light-info fs-8 fw-bolder"><?php echo e($schedule->school->name); ?></span>
                                                    <?php else: ?>
    ...
    document.addEventListener('DOMContentLoaded', function() {
        ...
        var genderChart = new Chart(ctx, {
            ...
            data: {
                labels: ['Putra', 'Putri'],
                datasets: [{
                    data: [<?php echo e($genderRatio['l']); ?>, <?php echo e($genderRatio['p']); ?>],
                    backgroundColor: [
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('layouts.master', ['title' => 'Dashboard Utama'], \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH F:\Antigravity\Projects\cahayatasbih\resources\views/admins/dashboard/index.blade.php ENDPATH**/ ?>