  ...
  return (
    <MobileShell>
      <header className="px-5 pt-10 pb-4 flex items-center gap-3">
        ...
        <Text.H1>Prestasi</Text.H1>
      </header>

      <section className="px-5 mt-6 flex-1 flex flex-col items-center justify-center py-20 text-center">
        <div className="w-20 h-20 rounded-[24px] bg-amber-50 flex items-center justify-center text-amber-600 shadow-[0_8px_30px_rgb(217,119,6,0.06)] mb-6 animate-pulse">
          <Trophy size={40} strokeWidth={1.5} />
        </div>
        
        <div className="bg-white rounded-[24px] p-6 shadow-[0_8px_30px_rgb(0,0,0,0.04)] border border-slate-50/50 max-w-sm w-full">
          <Text.Label className="text-amber-600 mb-2 block">Pencapaian Gemilang</Text.Label>
          <Text.H2 className="mb-3">Modul Prestasi & Bakat</Text.H2>
          <Text.Body className="text-slate-500 mb-4">
            Daftar penghargaan, piagam, serta pencapaian akademik maupun non-akademik santri yang membanggakan selama menempuh pendidikan.
          </Text.Body>
